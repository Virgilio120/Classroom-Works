...
public class MENU : MonoBehaviour
{
    ...
    public Button BotaoJogar, BotaoOpcoes, BotaoSair, BotaoInstruções;
    [Space(20)]
    ...
    void Start()
    {
        ...
        BotaoInstruções.onClick = new Button.ButtonClickedEvent();
        ...
        BotaoInstruções.onClick.AddListener(() => Opcoes(true));
    ...
    private void Opcoes(bool ativarOP)
    {
        ...
        BotaoInstruções.gameObject.SetActive(!ativarOP);
